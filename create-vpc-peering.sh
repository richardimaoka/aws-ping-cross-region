...
REQUESTER_CIDR_BLOCK=$(aws ec2 describe-vpc-peering-connections --query "VpcPeeringConnections[?RequesterVpcInfo.VpcId=='${REQUESTER_VPC_ID}'].RequesterVpcInfo.Region" --region "${REQUESTER_REGION}")
